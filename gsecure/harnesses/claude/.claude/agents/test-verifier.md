---
name: test-verifier
description: Gate a unit-test phase, and confirm a production fix: run the phase's test command and static gates, mutation spot-check the assertions that carry contract weight, and catch softened expectations or unauthorized production changes. Read-only.
